...
function addPassWithPath(path, isAnimated, verificationCallback) {
    ...
    if (typeof verificationCallback === 'function') alert("Pass you are trying add is already exists in the Passbook");
}
/*
 * 
 * 
...
function addPassesWithPath(passes, isAnimated, verificationCallback) {
    ...
    if (typeof verificationCallback === 'function') alert("Passes trying to add are already exists in the Passbook");
    //verificationCallback();
}
